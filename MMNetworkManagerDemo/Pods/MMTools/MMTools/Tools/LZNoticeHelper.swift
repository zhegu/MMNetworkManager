//
//  LZNoticeHelper.swift
//  mts-manager
//
//  Created by 李哲 on 2018/6/23.
//  Copyright © 2018年 com.ctsi.mts.iphone. All rights reserved.
//

/***
 * 2018-06-23 参考https://github.com/johnlui/SwiftNotice 创建文件
 *
 **/
...
extension UIResponder {
    ...
    @discardableResult
    public func pleaseWaitWithImages(_ imageNames: Array<UIImage>, timeInterval: Int) -> UIWindow{
        return LZNoticeHelper.wait(imageNames, timeInterval: timeInterval)
    }
    // api changed from v3.3
    @discardableResult
    public func noticeTop(_ text: String, autoClear: Bool = true, autoClearTime: Int = 1) -> UIWindow{
        return LZNoticeHelper.noticeOnStatusBar(text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    
    // new apis from v3.3
    @discardableResult
    public func noticeSuccess(_ text: String, autoClear: Bool = false, autoClearTime: Int = 3) -> UIWindow{
        return LZNoticeHelper.showNoticeWithText(LZNoticeType.success, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    public func noticeError(_ text: String, autoClear: Bool = false, autoClearTime: Int = 3) -> UIWindow{
        return LZNoticeHelper.showNoticeWithText(LZNoticeType.error, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    public func noticeInfo(_ text: String, autoClear: Bool = false, autoClearTime: Int = 3) -> UIWindow{
        return LZNoticeHelper.showNoticeWithText(LZNoticeType.info, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    
    // old apis
    @discardableResult
    public func successNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return LZNoticeHelper.showNoticeWithText(LZNoticeType.success, text: text, autoClear: autoClear, autoClearTime: 3)
    }
    @discardableResult
    public func errorNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return LZNoticeHelper.showNoticeWithText(LZNoticeType.error, text: text, autoClear: autoClear, autoClearTime: 3)
    }
    @discardableResult
    public func infoNotice(_ text: String, autoClear: Bool = true) -> UIWindow{
        return LZNoticeHelper.showNoticeWithText(LZNoticeType.info, text: text, autoClear: autoClear, autoClearTime: 3)
    }
    @discardableResult
    public func notice(_ text: String, type: LZNoticeType, autoClear: Bool, autoClearTime: Int = 3) -> UIWindow{
        return LZNoticeHelper.showNoticeWithText(type, text: text, autoClear: autoClear, autoClearTime: autoClearTime)
    }
    @discardableResult
    public func pleaseWait() -> UIWindow{
        return LZNoticeHelper.wait()
    }
    @discardableResult
    public func noticeOnlyText(_ text: String) -> UIWindow{
        return LZNoticeHelper.showText(text)
    }
...
public enum LZNoticeType{
    case success
    case error
    case info
}

public class LZNoticeHelper: NSObject {
    ...
    @discardableResult
    public static func wait(_ imageNames: Array<UIImage> = Array<UIImage>(), timeInterval: Int = 0, enableResponse: Bool = false) -> UIWindow {
        let screenFrame = (UIApplication.shared.keyWindow?.frame)!
        let frame = CGRect(x: screenFrame.size.width/2 - 50, y: screenFrame.size.height/2 - 50, width: 100, height: 100)
        let window = UIWindow()
        window.backgroundColor = UIColor.clear
        let mainView = UIView()
        ...
        if imageNames.count > 0 {
            ...
            ai.frame = CGRect(x: 32, y: 32, width: 36, height: 36)
            ai.startAnimating()
    ...
    @discardableResult
    public static func showNoticeWithText(_ type: LZNoticeType,text: String, autoClear: Bool, autoClearTime: Int) -> UIWindow {
...
class SwiftNoticeSDK {
    ...
    class public func draw(_ type: LZNoticeType) {
    ...
    class var imageOfCheckmark: UIImage {
        ...
        SwiftNoticeSDK.draw(LZNoticeType.success)
    ...
    class var imageOfCross: UIImage {
        ...
        SwiftNoticeSDK.draw(LZNoticeType.error)
    ...
    class var imageOfInfo: UIImage {
        ...
        SwiftNoticeSDK.draw(LZNoticeType.info)
...
extension UIWindow{
    public func hide(){
        LZNoticeHelper.hideNotice(self)
    }
}

fileprivate extension Selector {
    static let hideNotice = #selector(LZNoticeHelper.hideNotice(_:))
}

@objc extension LZNoticeHelper {
    
    // fix https://github.com/johnlui/SwiftNotice/issues/2
    public static func hideNotice(_ sender: AnyObject) {
